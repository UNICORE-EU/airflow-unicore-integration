...
with DAG(
    ...
    t1 = uc_ops.UnicoreExecutableOperator(name="task 1", task_id="1", executable="echo Hello World!", arguments=["Can you see me?", "if yes, this is great!!"])
...
echo The next three args are: $1 $2 $3
    ...
    t3 = uc_ops.UnicoreScriptOperator(name="script-task 2", task_id="3", script_content=script, arguments=["arg1", "arg2", "arg3"])