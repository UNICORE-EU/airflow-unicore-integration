...
with DAG(
    ...
    generic_executable_task = uc_ops.UnicoreExecutableOperator(
        name="echo-task",
        task_id="1",
...
echo The next three args are: $1 $2 $3
    """
    script_upload_task = uc_ops.UnicoreScriptOperator(
        name="script-task",
        task_id="2",
        script_content=script,
        arguments=["arg1", "arg2", "arg3"],
    )
    generic_app_task = uc_ops.UnicoreGenericOperator(
        task_id="3",
        name="date-task",
    ...
    generic_full_task = uc_ops.UnicoreGenericOperator(
        task_id="4",
        name="full-task",
        executable="echo",
        arguments=["arg1", "arg2", "arg3", "arg3.141", "$ARG1234"],
        environment=["ARG1234=arg4"],
        job_type="batch",
        parameters={"a": "b"},
    )
